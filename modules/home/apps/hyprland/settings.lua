...
hl.workspace_rule({ workspace = "3", no_rounding = true, decorate = false, persistent = true })
...
hl.window_rule({ match = { tag = "pip" }, decorate = true })
hl.window_rule({ match = { tag = "pip" }, rounding = 8 })
hl.window_rule({ match = { tag = "pip" }, border_size = 0 })
hl.window_rule({ match = { tag = "pip" }, no_shadow = true })
...
hl.window_rule({ match = { class = "(spotify|Spotify|fastpotify|chrome-open\\.spotify\\.com__.*)" }, workspace = "9" })
